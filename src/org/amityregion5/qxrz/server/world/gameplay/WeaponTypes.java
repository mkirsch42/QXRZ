...
public enum WeaponTypes {
    ...
    ROCKETGUN(	"ro", "Rocket Launcher", 	4, 		2, 	4, 	2,	3,	80, 	5000,	false,	"weapons/launcher",		"rocket"),
    KNIFE(		"kn", "Knife",				0,		0,	0,	0,	0,	0,		0,		false,	"projectiles/bullet",	"footstep");	
    ...
    private WeaponTypes(final String text, final String fullName, final int cmaxammo, final int clips, 
    		...
    		final int dmg, final int speed, final boolean auto, final String asset, final String sound) 
    {
        this.text = text;
